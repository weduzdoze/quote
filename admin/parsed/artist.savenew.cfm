...
<!--- do action="mArtist.saveNew" --->
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "mArtist">
<cfset myFusebox.thisFuseaction = "saveNew">
<cftry>
<cfoutput><cfinclude template="../model/mArtist/qry_saveNewArtist.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 21 and right(cfcatch.MissingFileName,21) is "qry_saveNewArtist.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_saveNewArtist.cfm in circuit mArtist which does not exist (from fuseaction mArtist.saveNew).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
