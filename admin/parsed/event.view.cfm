...
<!--- do action="mEvent.view" --->
<!--- do action="vEvent.view" --->
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "vEvent">
<cfset myFusebox.thisFuseaction = "view">
<cftry>
<cfsavecontent variable="fusebox.layout"><cfoutput><cfinclude template="../view/vEvent/dsp_eventList.cfm"></cfoutput></cfsavecontent>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 17 and right(cfcatch.MissingFileName,17) is "dsp_eventList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_eventList.cfm in circuit vEvent which does not exist (from fuseaction vEvent.view).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
