...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getArtists.cfm in circuit mArtist which does not exist (from fuseaction mArtist.view).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="vArtist.view" --->
<cfset myFusebox.thisCircuit = "vArtist">
<cftry>
<cfsavecontent variable="fusebox.layout"><cfoutput><cfinclude template="../view/vArtist/dsp_artists.cfm"></cfoutput></cfsavecontent>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 15 and right(cfcatch.MissingFileName,15) is "dsp_artists.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_artists.cfm in circuit vArtist which does not exist (from fuseaction vArtist.view).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
