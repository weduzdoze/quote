...
<!--- do action="mVenue.saveNew" --->
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "mVenue">
<cfset myFusebox.thisFuseaction = "saveNew">
<cftry>
<cfoutput><cfinclude template="../model/mVenue/qry_saveNewVenue.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "qry_saveNewVenue.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_saveNewVenue.cfm in circuit mVenue which does not exist (from fuseaction mVenue.saveNew).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="vVenue.saveNew" --->
