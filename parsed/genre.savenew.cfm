...
<!--- do action="mGenre.saveNew" --->
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "mGenre">
<cfset myFusebox.thisFuseaction = "saveNew">
<cftry>
<cfoutput><cfinclude template="../model/mGenre/qry_saveNewGenre.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "qry_saveNewGenre.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_saveNewGenre.cfm in circuit mGenre which does not exist (from fuseaction mGenre.saveNew).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="vGenre.saveNew" --->
