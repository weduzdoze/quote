...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getGenres.cfm in circuit mGenre which does not exist (from fuseaction mGenre.view).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<!--- do action="vGenre.view" --->
<cfset myFusebox.thisCircuit = "vGenre">
<cftry>
<cfsavecontent variable="fusebox.layout"><cfoutput><cfinclude template="../view/vGenre/dsp_genres.cfm"></cfoutput></cfsavecontent>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 14 and right(cfcatch.MissingFileName,14) is "dsp_genres.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_genres.cfm in circuit vGenre which does not exist (from fuseaction vGenre.view).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
