...
<cftry>
<cfoutput><cfinclude template="../model/mManage/qry_deleteRow.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 17 and right(cfcatch.MissingFileName,17) is "qry_deleteRow.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_deleteRow.cfm in circuit mManage which does not exist (from fuseaction mManage.delete).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
